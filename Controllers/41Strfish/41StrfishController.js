...
exports.getCalculatedData = (req,res) => {
    ...
    const headFees = (playerCount.find((x) => x.agentName === "STARFISH") && headfees.hasOwnProperty("41STRFISH")) ? parseInt(headfees["41STRFISH"] * playerCount.find((x) => x.agentName === "STARFISH")["playersCount"]).toFixed(2) : 0
