...
exports.getCalculatedData = (req,res) => {
    ...
    const headFees = (playerCount.find((x) => x.agentName === "BIGKALA1") && headfees.hasOwnProperty("BIGKALA1")) ? parseFloat(headfees["BIGKALA1"] * playerCount.find((x) => x.agentName === "BIGKALA1")["playersCount"]).toFixed(2) : 0
