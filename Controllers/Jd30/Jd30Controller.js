...
exports.getCalculatedData = (req,res) => {
    ...
    const headFees = (playerCount.find((x) => x.agentName === "JD30") && headfees.hasOwnProperty("JD30")) ? parseInt(headfees["JD30"] * playerCount.find((x) => x.agentName === "JD30")["playersCount"]).toFixed(2) : 0
