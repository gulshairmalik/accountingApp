...
exports.getCalculatedData = (req,res) => {
    ...
    const startMakeup = allMakeup.hasOwnProperty("jackson123") ? allMakeup["jackson123"] : 0
    ...
    const headFees = (playerCount.find((x) => x.agentName === "JACKSON123") && headfees.hasOwnProperty("JACKSON123")) ? parseFloat(headfees["JACKSON123"] * playerCount.find((x) => x.agentName === "JACKSON123")["playersCount"]).toFixed(2) : 0
    ...
    wb.write('./uploads/jackson123.xlsx', (err, stat) => {
        res.download('./uploads/jackson123.xlsx', (err) => {
            fsExtra.removeSync("./uploads/jackson123.xlsx")
