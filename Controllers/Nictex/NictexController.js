...
const ws = wb.addWorksheet('NICTEX')
const JSONdb = require('simple-json-db')
const db = new JSONdb('./Controllers/Nictex/db.json')
...
exports.getCalculatedData = (req,res) => {
  ...
  const startMakeup = allMakeup.hasOwnProperty("nictex") ? allMakeup["nictex"] : 0
  ...
  wb.write('./uploads/nictex.xlsx', (err, stat) => {
    res.download('./uploads/nictex.xlsx', (err) => {
      fsExtra.removeSync("./uploads/nictex.xlsx")
