...
exports.getCalculatedData = (req,res) => {
    ...
    const headFees = (playerCount.find((x) => x.agentName === "DSO") && headfees.hasOwnProperty("DSO")) ? parseFloat(headfees["DSO"] * playerCount.find((x) => x.agentName === "DSO")["playersCount"]).toFixed(2) : 0
