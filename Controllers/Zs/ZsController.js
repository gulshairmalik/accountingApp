...
exports.getCalculatedData = (req,res) => {
    ...
    const headFees = (playerCount.find((x) => x.agentName === "ZS") && headfees.hasOwnProperty("ZS")) ? parseInt(headfees["ZS"] * playerCount.find((x) => x.agentName === "ZS")["playersCount"]).toFixed(2) : 0
