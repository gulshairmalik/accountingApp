...
exports.getCalculatedData = (req,res) => {
    ...
    const headFees = (playerCount.find((x) => x.agentName === "M508") && headfees.hasOwnProperty("M508")) ? parseInt(headfees["M508"] * playerCount.find((x) => x.agentName === "M508")["playersCount"]).toFixed(2) : 0
